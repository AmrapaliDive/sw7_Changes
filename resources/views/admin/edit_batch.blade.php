...
<div class="col-md-12 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" role="form"  method="post" action="{{ url('/admin/batch/update/'.$batch->id) }}" enctype="multipart/form-data">
    {{csrf_field()}}
		...
		<div class="col-md-4 ">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" style="background:#ffc20e;color:#b60a0a;border-color:#ffc20e;font-size:18px;">Submit</button>
          </div></center>
	</form>
