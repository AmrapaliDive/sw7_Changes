	...
	<div class="panel-body row">
			<div class="col-md-12">
					...
					<tr style="">
							...
							<th>Name</th>
							<th>Online Transaction Query API </th>
						 	<!-- <th>10th School</th>
							<th>10th Board</th>
					...
					<tbody>
						@if($student != null)
								...
								<tr>
									...
									<a href="{{ asset($student->tenth_doc) }}" download class="btn btn-primary" style="font-size:1.4rem;background:#b60a0a;border-color:#b60a0a;">Download</a> 
									@endif
									</td>
