...
@if(session('success'))
	...
	<div class="btn-group " role="group" aria-label="Second group" style="float:right;padding-right:36px;margin-bottom:50px;">
			...
			<a class="btn btn-primary btn-lg py-3 px-5"style="background:#ffc20e;border-color:#ffc20e;" href="{{ url('admin/userblogs/create') }}"><b>New Blog</b></a><br>
	</div><br><br><br>
								...
								<tr>
									...
									<td>
										<div class="btn-group" role="group">
											<a class="btn btn-primary" style="background:#ffc20e;border-color:#ffc20e;font-size:14px;padding-right:10px;padding-left:10px;" href="{{ url('/admin/userblogs/edit/'.$blog->id) }}"style="background-color:white;color:black;border-color:black;">Edit</a>
											@if($i>5)
											<a class="btn btn-danger" style="font-size:14px;"  href="{{ url('/admin/userblogs/delete/'.$blog->id) }}">Delete</a>
											@endif
										</div>
									</td>
								</tr>
