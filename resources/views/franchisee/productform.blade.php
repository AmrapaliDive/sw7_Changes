...
@section('content')
	...
	<div class="page-header row">
            ...
            <h3 class="col-md-12 col-sm-8 col-xs-8" style="color:black;font-size:30px;padding-right:140px;"><center><strong >Product Form</strong></center> </h3>
		...
		enctype="multipart/form-data"   style="height:1250px;width:900px;border:1px solid black;border-radius:25px;padding-left:5px;padding-top:15px;margin-left:160px;">
			...
			<div class="col-md-6 ">
				...
				<div class="form-group">
					...
					<input type="text"  Style="font-size:1.5rem;"placeholder="Enter Product Title" class="form-control" id="product_name" name="product_name" value="{{ $product->product_name or '' }}"required/>
				</div>
			</div>
			 <div class="col-md-6 ">
				<div class="form-group">
					...
					@else
						<select  class="form-control " id="type"  style="height:47px;font-size:1.5rem;" name="type" required>
						<option>Select Type</option>
						...
						@if($dealer->category=="Multiple Category")
						<option>Collectibles</option>
						<option>Electronics</option>
						<option>Fashion</option>
						<option>Health & Beauty</option>
			...
			<div class="col-md-12 ">
				<div class="form-group">
					...
					@if(isset($product))
					<select  class="form-control " id="subtype"  style="height:47px;font-size:1.5rem;" name="subtype" required>
			...
			<div class="col-md-6 ">
				<div class="form-group">
					...
					<input type="number" style="font-size:1.5rem;" placeholder="Enter Product Title" class="form-control" id="quantity" name="quantity" min="1" value="{{ $product->quantity or '' }}"required/>
				</div>
			</div>
			...
			<div class="form-group">
					...
					<input type="number" style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="mrp" placeholder="Enter MRP" name="mrp"  value="{{ $product->mrp or '' }}" onblur = 'calculate()' required/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Discount(In Percentage)</label>
					<input type="number"  style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="discount" placeholder="Enter Discount" name="discount"  value="{{ $product->discount or '' }}" onblur = 'calculate()' required/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Price</label>
					<input type="number" style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="price" placeholder="Enter Price" name="price"  value="{{ $product->price or '' }}" required readonly/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Height</label>
					<input type="number"  style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="height" placeholder="Enter Height" name="height"  value="{{ $product->height or '' }}" required/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Width</label>
					<input type="number"  style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="width" placeholder="Enter Width" name="width"  value="{{ $product->width or '' }}" required/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Depth</label>
					<input type="number"  style="font-size:1.5rem;" pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="depth" placeholder="Enter Depth" name="depth"  value="{{ $product->depth or '' }}" required/>
			</div>
			</div>
			<div class="col-md-6 " >
			<div class="form-group">
					<label for="title">Weight</label>
					<input type="number" style="font-size:1.5rem;"  pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="weight" placeholder="Enter Weight" name="weight"  value="{{ $product->weight or '' }}" required/>
			</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file"style="font-size:1.5rem;"  class="form-control file" id="imagefile1" placeholder="Image" name="imagefile1"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file" style="font-size:1.5rem;" class="form-control file" id="imagefile2" placeholder="Image" name="imagefile2"/>
				</div>
			</div> 
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file" style="font-size:1.5rem;" class="form-control file" id="imagefile3" placeholder="Image" name="imagefile3"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file" style="font-size:1.5rem;" class="form-control file" id="imagefile4" placeholder="Image" name="imagefile4"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file"  style="font-size:1.5rem;"class="form-control file" id="imagefile5" placeholder="Image" name="imagefile5"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file"  style="font-size:1.5rem;"class="form-control file" id="imagefile6" placeholder="Image" name="imagefile6"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file" style="font-size:1.5rem;" class="form-control file" id="imagefile7" placeholder="Image" name="imagefile7"/>
				</div>
			</div>
			<div class="col-md-6 ">
			<div class="form-group">
					...
					<input type="file" style="font-size:1.5rem;" class="form-control file" id="imagefile8" placeholder="Image" name="imagefile8"/>
				</div>
			</div>
			<div class="col-md-12 ">
				<div class="form-group">
					<label for="title">Video</label>
					<input type="text" style="font-size:1.5rem;" placeholder="Enter Product Title Video" class="form-control" id="video" name="video" value="{{ $product->video or '' }}"/>
				</div>
			</div>
			<div class="col-md-12 ">
				<div class="form-group">
