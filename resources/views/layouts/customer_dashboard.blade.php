  ...
  <nav id="sidebar" class="sidebar-wrapper navbar-light bg-light">
    <div class="sidebar-content">
      <div class="sidebar-brand">
        <a href="{{ url('/ ') }}" class="text-dark"><b>SW7</b></a>
        <div id="close-sidebar">
          <i class="fas fa-times"></i>
        </div>
      </div><hr><center><span class=""><strong><i class="fa fa-envelope" aria-hidden="true"></i></strong> <a href="#">support@sw7infomedia.com</a></span></center>
	                      <center>  <span class="mr-2"><strong><i class="fa fa-phone" aria-hidden="true"></i></strong><a href="#"> 7030023002</a></span></center>
      <center><span style=" text-align:center;font-size:22px"><b>Customer</b></span></center>
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          ...
          @if(Auth::check())
          <span style="font-size: 15px"class="text-dark "><b>{{Auth::user()->email}}&nbsp;</b></span>   <a href="#" data-toggle="tooltip" data-placement="bottom" style="font-size: 20px" title=""></a>
      ...
      <div class="sidebar-menu" >
        ...
        <li>
            ...
            <a href="{{url('/customer/orders')}}">
              ...
              <span class="text-dark"><b>Orders</b></span>
              {{-- <span class="badge badge-pill badge-primary">Beta</span> --}}
            </a>
          </li>
          <li>
