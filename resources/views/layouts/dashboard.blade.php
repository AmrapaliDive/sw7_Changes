    ...
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          ...
          @if(Auth::check())
          <span style="font-size:18px;color:white !important;" class="text-dark"><b>Hi</b> {{Auth::user()->email}}&nbsp;</span>   <a href="#" data-toggle="tooltip" data-placement="bottom" style="font-size: 20px" title=""></a>
