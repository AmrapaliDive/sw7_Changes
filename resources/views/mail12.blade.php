...
<html>
  ...
  padding:5px;
        ...
        <body >
    <center>
    <img class="" src="<?php echo url('https://www.sw7infomedia.com/images/new/logo1.jpeg'); ?>" style="width:100px;height:100px;"/>
    ...
    <div style="text-align:right;">Date: {{$admission->created_at->format('d/m/Y')}}  &nbsp;&nbsp;&nbsp;</div>
    ...
    <!-- <center><h2 style= color:black; ><b><u> Student Details </u></b></h2></center> -->
        ...
        <table class="table table-bordered table-responsive" style="border:solid black 2px;border-collapse:collapse; text-align:center;width:900px; font-size:24;"  border=" ">
            ...
            <tr>
                ...
                <td >{{ $student->first_name }} {{ $student->fathers_name }}  {{ $student->last_name }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <th  style="color:black; font-size:15px;height:40px;" > GENDER </thbgcolor="#000000">
                <td >{{ $student->gender }}</td>
            </tr>   

            <tr>    
                <th  style="color:black; font-size:15px;height:40px;" >AADHAAR NO. </thbgcolor="#000000">
            ...
            <tr>    
                <th  style="color:black; font-size:15px;height:40px;" >EMAIL ID  </thbgcolor="#000000">
                <td >{{$student->email }}</td>
             </tr>
             <tr>   
                <th  style="color:black; font-size:15px;height:40px;" >MOBILE NUMBER </thbgcolor="#000000">
                <td >{{ $student->student_contact }}</td>
             </tr> 

             <tr>  
                <th  style="color:black; font-size:15px;height:40px;" >ALTERNATIVE MOBILE NUMBER  </thbgcolor="#000000">
                <td >{{ $student->parent_contact }}</td>
            </tr>
            <tr>
                <th  style="color:black; font-size:15px;height:40px;" >PERMANENT ADDRESS  </thbgcolor="#000000">
...
<div class="table" align="center"  style="overflow-x:auto;">
    ...
    <center><h2 style= color:black; ><b><u> Enrollment Details </u></b></h2></center>
        ...
        <thead>
            <tr height="40">
                <th  style="color:black; font-size:15px;height:40px;" >Batch Name  </thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" >Timetable </thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" >Course Fee(Rs.) </thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" >GST (%) </thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" > Discount(Rs.) </thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" >Total Fee(Rs.)</thbgcolor="#000000">
                <th  style="color:black; font-size:15px;height:40px;" >Admission Date </thbgcolor="#000000">
...
<tbody>
      <tr>
      <td style="height:40px;">{{$batch->batch_name}}</td>
      <td style="height:40px;">{{$admission->timetable}}</td>
      <td style="height:40px;">{{$batch->fee}}</td>
      <td style="height:40px;">{{$batch->gst}}</td>
      <td style="height:40px;">{{$batch->discount}}</td>
      <td style="height:40px;">{{$batch->course_final_fee}}</td>
      <td style="height:40px;">{{$admission->created_at->format('d/m/Y')}}</td>
...
<table class="table table-bordered table-responsive" style="border:solid black 2px;border-collapse:collapse; text-align:center;width:900px; font-size:24;"  border=" ">
<tr>
<td style="height:40px;">{!! $batch->description !!}</td>
</tr>
</table>
</div>
</div>
...
<img class="" src="<?php echo url('https://www.sw7infomedia.com/images/storage/students/'.$str); ?>" style="width:138px;height:190px;border:solid black;"/>
<center><a href="{{url('/student/couse/'.$admission->id)}}" class="btn btn-primary">Download Bill</a></center>
<h4><b>Online Verified By {{ $student->first_name }} {{ $student->last_name }}</b></h4><br><br>
<br><br>Thank You,
