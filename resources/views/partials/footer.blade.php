      ...
      <div class="col-md-6 col-sm-12">
          ...
          <div class="module-body">
            <ul class='list-unstyled'>
              ...
              @endif
              <li><a href="{{route('product.shoppingcart')}}" title="Order History" style="color:white;">Order History</a></li>
<!--<li><a href="{{url('/faq')}}" title="faq">FAQ</a></li>-->
          ...
          <div class="module-body">
            <ul class='list-unstyled'>
              ...
              <li><a href="{{url('/userblogs/all')}}" title="Blog" style="color:white;">Blog</a></li>
              <!--<li><a href="#" title="Company">Company</a></li>
              <li><a href="#" title="Investor Relations">Investor Relations</a></li>-->
              <li class=" last"><a href="{{url('/contact')}}" title="Suppliers" style="color:white;">Contact Us</a></li>
            </ul>
          </div>
          <!-- /.module-body --> 
              </div>
