      ...
      <div class="header-top-inner">
        ...
        <ul class="list-unstyled list-inline sansserif">
           ...
           @if(Auth::check())
            ...
            <li style="margin-left:130px;"><a href="{{url('/admin')}}" style="color:#B60A0A;" ><i class="icon fa fa-user"></i>My Account</a></li>
            @elseif(Auth::user()->role == "franchisee")
            <li style="margin-left:130px;"><a href="{{url('/franchisee_account')}}" style="color:#B60A0A;"><i class="icon fa fa-user"></i>My Account</a></li>
            @elseif(Auth::user()->role == "customer")
            <li style="margin-left:130px;"><a href="{{url('/user_account')}}" style="color:#B60A0A;"><i class="icon fa fa-user"></i>My Account</a></li>
            <!-- <li><a href="#"><i class="icon fa fa-heart"></i>Wishlist</a></li> -->
            @elseif(Auth::user()->role == "student")
            <li style="margin-left:130px;"><a href="{{url('/student_account')}}" style="color:#B60A0A;"><i class="icon fa fa-user"></i>My Account</a></li>
            @endif
            @endif
            ...
            @if(Auth::check())
            <li>
	        <a href="{{ url('/user/logout') }}" style="color:#B60A0A;"><i class="icon fa fa-user"></i>Logout</a></li>
          
        
         
                <li> <a href="{{ url('/customer') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;margin-right:9px;">
                <i class="fa fa-user" aria-hidden="true"></i> REGISTER AS CUSTOMER</a></li>
                <li style="margin:0px 5px"><a href="{{ url('/franchisee') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
                <i class="fa fa-user" aria-hidden="true"></i> REGISTER AS FRANCHISEE </a></li>
                <li style="margin:0px 5px;"><a href="{{ url('/student_registration') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
          ...
          <ul class="list-unstyled list-inline sansserif">
            <!--<li class="dropdown dropdown-small animate-dropdown " style="font-color:black;" > <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value " style="color:black;"><i class="icon fa fa-lock"></i>&nbsp;Sign in & Register</span><b class="caret" style="color:black;"></b></a>
              <ul class="dropdown-menu">-->
                ...
                <li style="margin:0px 5px;"><a href="{{ url('/customer') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
                <i class="fa fa-user" aria-hidden="true"></i> REGISTER AS CUSTOMER</a></li>
                <li style="margin:0px 5px"><a href="{{ url('/franchisee') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
                <i class="fa fa-user" aria-hidden="true"></i> REGISTER AS FRANCHISEE </a></li>
                <li style="margin:0px 5px;"><a href="{{ url('/student_registration') }}" class="sansserif" style="color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
        ...
        <div class="cnt-account">
          ...
          <li class="dropdown dropdown-small animate-dropdown " style="font-color:black;" > <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value " style="color:black;"><i class="icon fa fa-lock"></i>&nbsp;Sign in & Register</span><b class="caret" style="color:black;"></b></a>
              <ul class="dropdown-menu">
                ...
                <li style="color:black;"><a href="{{ url('/customer') }}" class="sansserif" style="color:black;">
                <i class="fa fa-user" aria-hidden="true" style="font-color:black;"></i> Register as Customer</a></li>
                <li style="color:black;"><a href="{{ url('/franchisee') }}" class="sansserif" style="color:black;" >
                <i class="fa fa-user" aria-hidden="true" style="font-color:black;"></i> Register as Franchisee </a></li>
                <li style="color:black;"><a href="{{ url('/student_registration') }}" class="sansserif" style="color:black;">
          ...
          <ul class="list-unstyled list-inline" style="margin-right:9px;">
            <li class="dropdown dropdown-small animate-dropdown " style="font-color:black;" > <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value " style="color:black;"><i class="icon fa fa-lock"></i>&nbsp;Sign in & Register</span><b class="caret" style="color:black;"></b></a>
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ url('/customer') }}" class="sansserif" >
                <i class="fa fa-user" aria-hidden="true"></i> Register as Customer</a></li>
                <li><a href="{{ url('/franchisee') }}" class="sansserif" >
                <i class="fa fa-user" aria-hidden="true"></i> Register as Franchisee </a></li>
                <li><a href="{{ url('/student_registration') }}" class="sansserif" >
                <i class="fa fa-graduation-cap" aria-hidden="true"></i> Register as Student </a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{url('/')}}"> <img src="{{ asset('images/new/sw7123.jpg') }}" alt="logo" style="height:80px; margin-top:-20px;"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row"> 
          ...
          <div class=" dropdown-cart " style="float:left;">
             <a href="{{route('product.shoppingcart')}}" class="lnk-cart" style="background-color:#f7f7f7;width:165px;">
  ...
  <div class="header-nav animate-dropdown" style="background-color:#B60A0A;">
    ...
    <div class="col-md-1" style="width:10px;"></div>
      ...
      <!--<img src="/images/navicons/laptopnew.png" class="navicons" style="margin-left:10px;">-->
				<a href="{{url('/')}}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown" style="color:white;">Laptop</a>
    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                ...
                <ul class="links">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu">
                        <h2 class="title" style="color:black;">Components</h2>
						<ul class="links">
            <li><a href="{{url('/ics')}}">IC</a></li>
            ...
            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" style="color:white;">Mobile</a>
                  <ul class="dropdown-menu pages">
                    <li>
                      <div class="yamm-content" style="background-color:#ffc20e;">
                        <div class="row">
                          <div class="col-xs-6 col-menu">
                            <ul class="links">
                            <li><a href="{{url('/Mobiles')}}" style="font-weight:bold;">Mobiles</a>
                                <ul class="links">
                                          <li><a href="{{url('/oppo')}}">Oppo</a></li>
                                          <li><a href="{{url('/iphone')}}">Iphone</a></li>
                                          <li><a href="{{url('/redmi')}}">Redmi</a></li>
                                          <li><a href="{{url('/samsung')}}">Samsung</a></li>
                                          <li><a href="{{url('/itel')}}">Itel</a></li>
                                          <li><a href="{{url('/vivo')}}">Vivo</a></li>
                                  </ul>
                          ...
                          <div class="col-xs-6 col-menu">
                            <ul class="links">
                            <li><a href="{{url('/mobile_accessories')}}" style="font-weight:bold;">Accessories</a>
                                <ul class="links">
                                          <li><a href="{{url('/headsets')}}">Bluetooth-Headphone & Headsets</a></li>
    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-menu">
                ...
                <a href="{{url('/gallery')}}" data-hover="dropdown" data-toggle="dropdown" style="color:white;">Gallery</a></li>
                <li class="links dropdown">
                <!--<img src="/images/navicons/contact.png" class="navicons" style="margin-left:20px;"> --> 
                <a href="{{url('/contact')}}" data-hover="dropdown" class="dropdown-toggle" style="color:white;">Contact</a></li>
