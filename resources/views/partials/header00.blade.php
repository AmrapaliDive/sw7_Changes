             ...
             <form action="{{ url('/productsearch') }}" method="get">
              ...
              <div class="control-group " style="border: 2px solid #f3f3f3;">
                <!-- <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="#" style="color:black;">Categories <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      <li class="menu-header">Computer</li>
                      
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="all_new_laptop">- Laptop</span></li>
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="all_new_desktop">- Desktop</span></li>
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="{{url('/all_printer')}}">- Printers</span></li>
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="{{url('all_accessories')}}">- Accessories</span></li>
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="{{url('/memory_devices')}}">- memory</span></li>
                      <li role="presentation"><span role="menuitem" tabindex="-1" href="{{url('/softwares')}}">- Software</span></li>
                    </ul>
                  </li>
                </ul> -->
                <input class="search-field" name="psearch" placeholder="Search Products and Courses"/>
  ...
  <div class="header-nav animate-dropdown" style="background-color:#f7f7f7;">
    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                ...
                <ul class="links">
                <li><a href="{{url('/dell_new_desktop')}}"> Desktop</a></li>
    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                ...
                <li class="dropdown"> <a href="{{url('/repairing_tools')}}" class="" data-hover="" data-toggle="" style="color:black;">Repairing tools</a>
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" style="color:black;">Software</a>
                          ...
                          <div class="col-xs-12 col-sm-12 col-md-6 col-menu">
                            ...
                            <li><a href="{{url('/freeze_repair')}}">Freeze Repairing Course </a></li>
                              ...
                              <li><a href="{{url('/xerox_repair')}}">Xerox Machine Repairing Course  </a></li>
							                                <li><a href="{{url('/owen_repair')}}">Oven Repairing Course</a></li>
                              ...
                              <li><a href="{{url('/washing_machine_repair')}}">Washing Machine Repairing Course</a></li>
				 ...
				 <li class="link"> <a href="{{url('/ics_and_components')}}" class="" data-hover="" data-toggle="" style="color:black;">ICS and components</a>
                  <!--<ul class="dropdown-menu pages">
                    <li>
                      <div class="yamm-content">
                        <div class="row">
