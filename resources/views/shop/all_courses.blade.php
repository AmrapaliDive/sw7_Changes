...
@section('css')
	...
	<link rel="stylesheet" href="{{ asset('other/css/animate-wow.css') }}">
      <!--main css-->

       <link rel="stylesheet" href="{{ asset('other/css/style.css') }}">
      <link rel="stylesheet" href="{{ asset('other//bootstrap-select.min.css') }}">
      <link rel="stylesheet" href="{{ asset('other/css/slick.min.css') }}"> 
      <!--responsive css-->
         ...
         <div class="main-product">
            <div class="container">
               ...
               <div class="row clearfix">
                  ...
                  <a href="{{url('/course_select/Laptop Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/laptop.png')}}" alt=""  style="height:100px;"/>
                           <h4>Laptop Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/Printer Repairing Course')}}">
                        <div class="box-img text-center">
                        <img src="{{asset('images/new/icon/printer-with-paper.png')}}" alt="" style="height:100px;"/>
                         <h4>Printer Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/LCD Repairing Course')}}">
                        <div class="box-img text-center">
                        <img src="{{asset('images/new/icon/repair.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/Mobile Repairing Course')}}">
                        <div class="box-img text-center">
                        <img src="{{asset('images/new/icon/mrepair.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/HDD Repairing Course')}}">
                        <div class="box-img text-center">
                        <img src="{{asset('images/new/icon/hard-disk-drive.png')}}" alt="" style="height:100px;"/>
                        <h4>Hdd Repairing Course</h4> 
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/CCTV Repairing Course')}}">
                        <div class="box-img text-center">
                        <img src="{{asset('images/new/icon/cctv.png')}}" alt="" style="height:100px;"/>
                        <h4>CCTV Repairing Course</h4> 
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/Washing Machine Repairing Course')}}">
                        <div class="box-img text-center">
                          <img src="{{asset('images/new/icon/washing-machine.png')}}" alt="" style="height:100px;"/>
                          <h4>Washing Machine Repairing </h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/Motor Winding Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/electric-motor.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/course_select/Grinder Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/grinder.png')}}" alt="" style="height:100px;"/>
                 ...
                 <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/AC Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/air-conditioner.png')}}" alt="" style="height:100px;"/>
                           <h4>AC Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Freeze Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/freezer.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Xerox Machine Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/xerox-machine.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Fan Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/fan.png')}}" alt="" style="height:100px;"/>
                           <h4>Fan Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Cooler Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/air-cooler.png')}}" alt="" style="height:100px;"/>
                           <h4>Cooler Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Owen Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/owen.png')}}" alt="" style="height:100px;"/>
                           <h4>Owen Repairing Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Elevator Repairing Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/elevator.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Basic Electronic Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/screwdriver.png')}}" alt="" style="height:100px;"/>
                           <h4>Basic Electronic Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Computer Hardware Course')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/computer.png')}}" alt="" style="height:100px;"/>
                           <h4>Computer Hardware Course</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Combo Course 1')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/hand-tools.png')}}" alt="" style="height:100px;"/>
                           <h4>Combo Course 1</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Combo Course 2')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/hand-tools.png')}}" alt="" style="height:100px;"/>
                  ...
                  <div class="row clearfix">
                  <div class="col-lg-3 col-sm-6 col-md-3">
               <a href="{{url('/course_select/Combo Course 3')}}">
                        <div class="box-img text-center">
                           <img src="{{asset('images/new/icon/hand-tools.png')}}" alt="" style="height:100px;"/>
