...
@section('content') 
	...
	<div class="container">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 groove " style="">
          ...
          <!-- <form name="sentMessage" id="contactForm" novalidate> -->
          <form id="validate_form"  method="post" action="{{ url('/contact/insert') }}" name="sentMessage">
						{{ csrf_field() }}
          ...
          <h3 style="text-align:center"><b style="font-family:Rockwell; color:black;">Contact Details </b></h3>
					<!-- <i class="fa fa-address-card-o" style="font-size:36px"></i> -->
						...
						{{-- <h5 style="font-size:16px;">&nbsp;<i class="fa fa-map blink"  style="font-size:16px;"></i>&nbsp;Address :</h5>
            <p>         Shop No 5, .<br>  
           </p> --}}
...
{{-- 
            <h3><b style="font-family:Rockwell;color:black;">Buyer Protection Policies </b></h3>

       <p style="color: black;font-size:22px"> 
        We offer 100% Buyer Protection Policy to our customers.
         Our Brand of trust clearly defines our values, promising the best online shopping experience to our customers.
