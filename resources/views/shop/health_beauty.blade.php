...
<div class="row">
  <div class="col-sm-2" style="margin-top:1px;">
    <p style="color:black; font-size:30px; font-weight:400">Helath & Beauty</p>
    <div class="menus">
    <ul>
  
      <p>Shop by Category</p>
      <li><a href="{{url('/makeup')}}">Makeup</a></li>
      <li><a href="{{url('/health')}}">Health</a></li>
      <li><a href="{{url('/fragrance')}}">Fragrances</a></li>
      <li><a href="{{url('/nailcare')}}">Manicure, Pedicure & Nail Care Products</a></li>
      <li><a href="{{url('/skincare')}}">Skin Care Products</a></li>
      <li><a href="{{url('/haircare')}}">Hair Care & Styling Products</a></li>
      <li><a href="{{url('/Shaving')}}">Shaving & Hair Removal Products</a></li>
      <li><a href="{{url('/bath')}}">  Bath & Body Products</a></li>
      <li><a href="{{url('/visioncare')}}">Vision Care</a></li>
       ...
       <p style="font-size:20px;color:black; text-align:left; font-weight:400; margin-bottom:10px;">Shop By Category</p>
        <div class="row" >
          <div class="column">
            <a href="{{url('/makeup')}}">
              ...
              <img class="card-img-top" src="{{asset('images/health_beauty/makeup-products.jpg')}}" alt="product" style="width:100%; height:140px;">
              <div class="card-body">
                  <p class="card-title">Makeup</p>
                </div>
              </div>
            </a>  
          </div>
          <div class="column">
            <a href="{{url('/health')}}">
              <div class="card text-center">
              <img class="card-img-top" src="{{asset('images/health_beauty/health.png')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
          ...
          <div class="column">
            <a href="{{url('/fragrance')}}">
              <div class="card text-center" >
              <img class="card-img-top" src="{{asset('images/health_beauty/fragrance.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Fragrance</p>
                </div>
              </div>
            </a>
          </div>
          <div class="column">
            <a href="{{url('/nailcare')}}">
                <div class="card text-center" >
                <img class="card-img-top" src="{{asset('images/health_beauty/nail_care.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Manicure, Pedicure & Nail Care</p>
                </div>
                </div>
            </a>
          </div>
          <div class="column">
            <a href="{{url('/skincare')}}">
                <div class="card text-center" >
                <img class="card-img-top" src="{{asset('images/health_beauty/skin_care.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Skincare</p>
                </div>
                </div>
            </a>
          </div>
        ...
        <div class="row" style="margin-top:40px">
          <div class="column">
            <a href="{{url('/haircare')}}">
               <div class="card text-center">
               <img class="card-img-top" src="{{asset('images/health_beauty/hair_care.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Hair Care & Styling Products</p>
                </div>
                </div>
            </a>
          </div>
          <div class="column">
            <a href="{{url('/Shaving')}}">
                <div class="card text-center">
                <img class="card-img-top" src="{{asset('images/health_beauty/Shaving.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Shaving & Hair Removal</p>
                </div>
                </div>
            </a>
          </div>
          <div class="column">
            <a href="{{url('/bath')}}">
                <div class="card text-center" >
                <img class="card-img-top" src="{{asset('images/health_beauty/Bath.png')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Bath & Body</p>
                </div>
                </div>
            </a>
          </div>
          <div class="column">
              <a href="{{url('/visioncare')}}">
                <div class="card text-center" >
                <img class="card-img-top" src="{{asset('images/health_beauty/visioncare.jpg')}}" alt="product" style="width:100%; height:140px;">
                <div class="card-body">
                  <p class="card-title">Vision Care</p>
                </div>
                </div>
              </a>
          </div>
