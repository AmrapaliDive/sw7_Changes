...
<div class="col-md-12" style="margin-top:1px; margin-bottom:30px;">
   ...
   <h2 style="color:black;"><strong>Sports</strong></h2>
   </div>
  </center>
    </div>
...
<div class="row clearfix">
                  ...
                  <a href="{{url('/textile')}}">
                        <div class="box-img">
                           <img src="{{asset('images/sports/cycle.png')}}" alt=""  style="width:100%;height:180px;"/>
                           <h4>Apparel & Textile Machinery</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/building')}}">
                        <div class="box-img">
                        <img src="{{asset('images/sports/outdoor.jpg')}}" alt="" style="width:100%;height:180px;"/>
                         <h4>Building Material Machinery</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/cleaning')}}">
                        <div class="box-img">
                        <img src="{{asset('images/sports/hunting.jpg')}}" alt="" style="width:100%;height:180px;"/>
                  ...
                  <a href="{{url('/chemical')}}">
                        <div class="box-img">
                        <img src="{{asset('images/sports/fishing.jpg')}}" alt="" style="width:100%;height:180px;"/>
                         <h4>Chemical & Pharmaceutical Machinery</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/yoga')}}">
                        <div class="box-img">
                           <img src="{{asset('images/sports/yoga.jpg')}}" alt="" style="width:100%;height:180px;"/>
                           <h4>Air-Compressors & Parts</h4>
                        </div>
                     </a>
                  </div>
