...
// $surl = "http://localhost/sw7/public/transactionSuccess";
// $furl ="http://localhost/sw7/public/home/payment_error";

$surl = "https://www.sw7infomedia.com/transactionSuccess";
$furl ="https://www.sw7infomedia.com/home/payment_error";
 
$hash_string = 'FsSzqFiq|'.$txnid.'|'.$total.'|'.'Crestokart Product'.'|'.$customer->first_name.'|'.$customer->email.'|||||||||||YAFfyRAHeB';
...
<input type="hidden" name="firstname" value="<?php echo $customer->first_name ?>" />
<input type="hidden" name="lastname" value="<?php echo Auth::user()->name ?>" />
<input type="hidden" name="email" value="<?php echo $customer->email ?>" />
<input type="hidden" name="phone" value="<?php echo $customer->contact?>" />
<input type="hidden" name="surl" value="<?php echo $surl; ?>" />
<input type="hidden" name="furl" value="<?php echo $furl; ?>" />
<input type="hidden" name="service_provider" value="payu_paisa" />
<textarea name="productinfo" hidden><?php echo "Crestokart Product" ?></textarea>
<div class="col-xs-12">
<div class="row">
                    <div class=" col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="address1" class="form-control" name="address1" value="{{$customer->address}}" required>
                        </div>
                    </div>
                    <div class="col-xs-12">
