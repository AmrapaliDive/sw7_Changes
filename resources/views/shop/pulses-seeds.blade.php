...
<div class="container" style="margin-top:0px;">
    ...
    <div class="col-md-12 col-md-offset-3"style="margin-bottom:30px;">
...
@foreach($products->chunk(3) as $productChunk)
      ...
      <div class="col-md-3 card"style="margin-bottom:30px;">
      <a href="{{ url('productview/'.$product->id) }}" >
      <!-- <form method="GET" action="{{ url('/getAddToCartThird/'.$product->id) }}" >
      {{ csrf_field() }} -->
     
            <img style="margin-left: 0px;margin-right: 0px;height:100%;width:100%" src="{!!  URL::to('/images/vege/'.$product->path) !!}  " alt="Product" class="img-responsive">
