...
<div class="col-md-12" style="margin-top:1px; margin-bottom:30px;">
   ...
   <h2 style="color:black;"><strong>Health & Beauty</strong></h2>
   </div>
  </center>
    </div>
...
<div class="row clearfix">
                  ...
                  <a href="{{url('/FireAlarmAndOtherControlPanels')}}">
                        <div class="box-img">
                           <img src="{{asset('images/health_beauty/makeup-products.jpg')}}" alt=""  style="width:100%;height:180px;"/>
                           <h4>Makeup</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/FireDetectionEquipments')}}">
                        <div class="box-img">
                        <img src="{{asset('images/health_beauty/health.png')}}" alt="" style="width:100%;height:180px;"/>
                         <h4>health</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/FireAlarmSystemEquipments')}}">
                        <div class="box-img">
                        <img src="{{asset('images/health_beauty/fragrance.jpg')}}" alt="" style="width:100%;height:180px;"/>
                         <h4>Fragrance</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/PassiveFireProtectionSystem')}}">
                        <div class="box-img">
                        <img src="{{asset('images/health_beauty/nail_care.jpg')}}" alt="" style="width:100%;height:180px;"/>
                         <h4>Manicure, Pedicure & Nail Care</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/FireExtinguisher')}}">
                        <div class="box-img">
                        <img src="{{asset('images/health_beauty/hair_care.jpg')}}" alt="" style="width:100%;height:180px;"/>
                        <h4>Hair Care & Styling Products</h4> 
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/HydrantSystem')}}">
                        <div class="box-img">
                        <img src="{{asset('images/health_beauty/skin_care.jpg')}}" alt="" style="width:100%;height:180px;"/>
                        <h4>Skin Care</h4> 
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/SprinklerSystem')}}">
                        <div class="box-img">
                          <img src="{{asset('images/health_beauty/Shaving.jpg')}}" alt="" style="width:100%;height:180px;"/>
                          <h4>Shaving & Hair Removal</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/OtherFireFightingSystems')}}">
                        <div class="box-img">
                           <img src="{{asset('images/health_beauty/visioncare.jpg')}}" alt="" style="width:100%;height:180px;"/>
                           <h4>Vision Care</h4>
                        </div>
                     </a>
                  </div>
                  <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="{{url('/OtherServices')}}">
                        <div class="box-img">
                           <img src="{{asset('images/health_beauty/Bath.png')}}" alt="" style="width:100%;height:180px;"/>
                           <h4>Bath & Body</h4>
                        </div>
                     </a>
                  </div>
