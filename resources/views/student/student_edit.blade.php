...
<div class="col-md-12 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" role="form"  action="{{url('/student/update')}}" id="Validate_form"class="text" method='POST' enctype='multipart/form-data' >
    {{csrf_field()}}
       ...
       <div class="col-md-4">
            ...
            <div class="form-group">
                   <label  class="info-title" for="email" >&nbsp;<i class="fa fa-envelope"></i>&nbsp;Email</label>
                    <input type="text" id="email" name="email" class="form-control" style="font-size:1.5rem" autofocus placeholder="Enter Email"  required value="{{$student->email}}" readonly>
                </div>
                </div>
               ...
               <div class="form-group">
                <label  class="info-title" for="cnumber" >&nbsp;<i class="fa fa-phone"></i>&nbsp;Parent Contact </label>
			      	<input type="text" id="parent_contact" style="font-size:1.5rem" autofocus maxlength=10 pattern="(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}" class="form-control" name="parent_contact" data-parsley-pattern-message="Contact should be in digits only" data-parsley-length-message="Contact Number should be of (10) digits" required autofocus  placeholder="Enter Contact Number" value="{{$student->parent_contact}}">
                </div>
               </div>
               ...
               <div class="form-group">
                ...
                <label  class="info-title" for="name" ><i class="fa fa-map-pin" aria-hidden="true"></i>&nbsp;Pincode</label>
				        <input type="text"id="pincode" class="form-control" style="font-size:1.5rem" name="pincode"  maxlength="6" data-parsley-pattern="[0-9]+$" data-parsley-pattern-message="Pincode should be in digits only" data-parsley-length-message="Pincode should be of (6) digits" required autofocus placeholder="Enter Pincode" value="{{$student->pincode}}">
                </div>
                </div>
				...
				<input type="text" id="permanent_address" style="font-size:1.5rem" class="form-control" name="permanent_address" required autofocus  placeholder="Enter Address" value="{{$student->permanent_address}}">
                </div>
       </div>
...
<hr><br>
        ...
        {{csrf_field()}}
            ...
            <div class="form-group">
				...
				<input type="text"id="first_name" class="form-control" style="font-size:1.5rem" name="first_name" pattern="[A-Za-z]+" required autofocus placeholder="Enter First Name" value="{{$student->first_name}}">
            </div>
       </div>
       <div class="col-md-5">
            <div class="form-group">
                <label for="name" class=" " style="color:black ;">&nbsp;<i class="fa fa-user"></i>&nbsp;Last Name</label>
				    <input type="text"id="last_name" class="form-control" style="font-size:1.5rem" name="last_name" pattern="[A-Za-z]+" required autofocus placeholder="Enter Last Name" value="{{$student->last_name}}">
            </div>
            </div>
            <div class="col-md-5">
            ...
            <div class="form-group">
                <label for="email" class=" " style="color:black ;">&nbsp;<i class="fa fa-envelope"></i>&nbsp;Email</label>
                    <input type="text" id="email" name="email" class="form-control" style="font-size:1.5rem" autofocus placeholder="Enter Email"  required value="{{$student->email}}">
                </div>
                </div>
                <div class="col-md-5">
                ...
                <label for="cnumber" class=" " style="color:black ;">&nbsp;<i class="fa fa-phone"></i>&nbsp;Contact </label>
			      	<input type="text" id="contact" style="font-size:1.5rem" autofocus maxlength=10 pattern="(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[789]\d{9}" class="form-control" name="contact" required autofocus  placeholder="Enter Contact Number" value="{{$student->contact}}">
                </div>
               </div>
                 <!-- <div class="col-md-5">
                ...
                <label for="name" class=" " style="color:black ;">&nbsp;<i class="fa fa-user"></i>&nbsp;City</label>
      			  	<input type="text"id="city" class="form-control" style="font-size:1.5rem" name="address"  required autofocus placeholder="Enter Address" value="{{$student->address}}">
                </div>
                </div> --
                <div class="col-md-5">
                ...
                <label for="name" class=" " style="color:black ;">&nbsp;<i class="fa fa-user"></i>&nbsp;Pincode</label>
				        <input type="text"id="pincode" class="form-control" style="font-size:1.5rem" name="pincode"  maxlength="6" required autofocus placeholder="Enter Pincode" value="{{$student->pincode}}">
                </div>
                </div>
                 <div class="col-md-5">
				...
				<input type="text" id="address" style="font-size:1.5rem" class="form-control" name="address" required autofocus  placeholder="Enter Address" value="{{$student->address}}">
                </div>
                ...
                <label for="dob" class=" " style="color:black ;">&nbsp;Date Of Birth</label>
					<input type="date" placeholder="Enter Birth Date" class="form-control" style="font-size:1.5rem" id="dob" name="dob" required value="{{$student->dob}}">
				</div> --
</div>
