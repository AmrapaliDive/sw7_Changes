...
<div class="container" style="margin-top:50px;border:1px solid lightgray;background-color:white;border-radius:12px;box-shadow: 4px 4px 4px 0 rgba(0,0,0,0.7);margin-bottom:80px;">	
 ...
 <div class = "bikini-grid1" style="">
  ...
  <div class="col-md-6">
       ...
       <div class="p-4"> 
       <img id="main-image" src="<?php echo URL::to('/images/products'.'/'.$product->path); ?>" style="width:350px;height:450px; margin-top:15px;border:0px !important;"  class="img-thumbnail" />
        </div>
        <div style="border:none;padding-left:25px;">
        <?php if($product->path2!=="NA"): ?>
         <img onclick="change_image(this)" src="<?php echo URL::to('/images/products'.'/'.$product->path2); ?>" width="90">
         <?php endif; ?>

         <?php if($product->path3!=="NA"): ?>
		 <img onclick="change_image(this)" src="<?php echo URL::to('/images/products'.'/'.$product->path3); ?>" width="90">
		 <?php endif; ?>
           
           <img onclick="change_image(this)" src="<?php echo URL::to('/images/products'.'/'.$product->path); ?>" width="90">
            </div>
  ...
  <h4><?php echo e($product->title); ?></h4>
		<span style="font-family:Roboto, serif;color:black;font-size:15px;"><b>Product Name :-</b></span><b><span style="font-family:Roboto; font-size:14px;"> <?php echo e($product->product_name); ?></span></b><br><br>
		<span style=" font-family:Roboto, serif; font-size:15px;color:black;"><b>Product Category :-</b></span><span style="font-family:Roboto;font-size:14px;"> <?php echo e($product->type); ?></span><br><br>
    ...
    <b style="font-family:Roboto, serif;color:black;font-size:15px;">MRP at Price :- ₹
           ...
           </b ><span  class="card__by" id="card__by" name="card__by" style="font-family:Roboto; font-size:14px;text-decoration: line-through;"><?php echo e($product->mrp); ?> </span> <br> <br>
            <b style="font-family:Roboto;color:black;font-size:15px;">Discount :- ₹ <span  style="font-family:Roboto;color:black;"></b> <?php echo e($product->discount); ?> </span> </span>  <br> <br>
            <b style="font-family:Roboto;color:black;font-size:15px;">GST :- 
           
           <span  class="card__by1" id="card__by1" name="card__by1" style="font-family:Roboto;"></b><?php echo e($product->gst); ?> % </span> <br> <br>
            
             <b style="font-family:Roboto;color:black;font-size:15px;">Available at Price :- ₹
           
            <span  class="card__by1" id="card__by1" name="card__by1" style="font-family:Roboto"></b><b style=" font-size:15px;"><?php echo e($product->price); ?> </b></span> 
