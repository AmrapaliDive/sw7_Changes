                      ...
                      <div class="yamm-content" style="background-color:#ffc20e;">
                        <div class="row">
                          <div class="col-xs-6 col-menu">
                            <ul class="links">
                            <li><a href="<?php echo e(url('/Mobiles')); ?>" style="font-weight:bold;">Mobiles</a>
                                <ul class="links">
                                          <li><a href="<?php echo e(url('/oppo')); ?>">Oppo</a></li>
                                          <li><a href="<?php echo e(url('/iphone')); ?>">Iphone</a></li>
                                          <li><a href="<?php echo e(url('/redmi')); ?>">Redmi</a></li>
                                          <li><a href="<?php echo e(url('/samsung')); ?>">Samsung</a></li>
                                          <li><a href="<?php echo e(url('/itel')); ?>">Itel</a></li>
                                          <li><a href="<?php echo e(url('/vivo')); ?>">Vivo</a></li>
                                  </ul>
                          ...
                          <div class="col-xs-6 col-menu">
                            <ul class="links">
                            <li><a href="<?php echo e(url('/mobile_accessories')); ?>" style="font-weight:bold;">Accessories</a>
                                <ul class="links">
                                          <li><a href="<?php echo e(url('/headsets')); ?>">Bluetooth-Headphone & Headsets</a></li>
                                          <li><a href="<?php echo e(url('/gadgets')); ?>">Gadgets</a></li>
