			...
			<tbody>
				<tr>
					      ...
					      <td class="actions"  data-th="">
                              ...
                              <input type="hidden" name="quantity[]" value="<?php echo e($product['item']['id']); ?>" />
                                 <button class="btn btn-xs dropdown-toggle " type="button" data-toggle="dropdown" style= "font-size:19px;">
									  ...
									  <ul class="dropdown-menu">
											<!-- <li><a id="ab" href="<?php echo e(route('product.deductByOne', ['product' => $product['item']['id']])); ?>" style="font-size:17px;" onclick="return confirm('Are you sure you want to remove this item?');">Remove item from cart by one</a> </li> -->
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Grand Total (In ₹ ) :<span id="tamount" class="inner-left-md"z><?php echo e($totalPrice); ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<!-- <a href="<?php echo e(route('checkout')); ?>" class="btn btn-upper btn-primary outer-left-xs" type="button" onclick="return confirm('Are you sure you want to continue?');">
                                 <i class="fa fa-money"></i> Cash On Delivery </a> -->
                                 
								<a href="<?php echo e(route('onlinePayment')); ?>" class="btn btn-upper btn-primary pull-right outer-right-xs" type="button" onclick="return confirm('Are you sure you want to continue?');"><i class="fa fa-credit-card"></i> Checkout</a>
							</span>
...
<?php else: ?>
      ...
      <div class="container">
            ...
            <center><img src="<?php echo URL::to('/images/Icon-no-cart.png'); ?>" class="" style="margin-top:50px;height:150px;width:200px;"/></center>
                <h3 style="color:black;margin-top:30px;font-size:30px; margin-bottom:30px;">
                <center>No Products added to your Cart.</center></h3>
             
                <center> <a href="<?php echo e(url('/')); ?>" class="btn btn-primary btn-lg" style=""> <center> Continue Shopping</center></a></center>
