  ...
  <nav id="sidebar" class="sidebar-wrapper navbar-light bg-light">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        ...
        <span style="font-size: 18">or</span>   <a href="<?php echo e(url('/dealer')); ?>" data-toggle="tooltip" data-placement="bottom" style="font-size: 20px" title="">Register as Dealer</a> 
        <span style="font-size: 18">or</span>   <a href="<?php echo e(url('/customer')); ?>" data-toggle="tooltip" data-placement="bottom" style="font-size: 20px" title="">Register as Customer</a> &nbsp;|&nbsp;&nbsp;
