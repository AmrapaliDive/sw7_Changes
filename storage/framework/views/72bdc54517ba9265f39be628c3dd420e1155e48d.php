...
<?php $__env->startSection('content'); ?>
  ...
  <div class="container" style="margin-top:30px;">
    ...
    <a href="<?php echo e(url('/')); ?>" class="btn btn-warning pull-left"><i class="fa fa-angle-left"></i> Continue Shopping</a>
</div>
</div>
...
<?php $__currentLoopData = $products->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productChunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  background:white;height:fit-content;min-height:340px;margin:35px;">  
      <a href="<?php echo e(url('productview/'.$product->id)); ?>" >
            <center><img style="margin-left:0px;margin-right:0px;margin-top:15px;width:300px;height:280px;" class="img-thumbnail"src="<?php echo URL::to('images/products',array($product->path)); ?>  " alt="Product" class="img-responsive"></center>
            <div class="card__info">
              <!-- <span class="card__category"><?php echo e($product->type); ?></span> -->
              <h4 class="card__title"style="font-family:Times New Roman, Times, serif" ><?php echo e($product->product_name); ?></h4>
              ...
              <span class="card__by" id="card__by" name="card__by" style="font-family:sans-serif;">
               <?php echo e($product->mrp); ?></span> 
              <!-- <b> /unit</b> -->
             <input type="hidden" name="amount" id="amount"  value="<?php echo e($product->mrp); ?>"  class="amount"/>   
             <input type="hidden" name="productid" id="productid"  value="<?php echo e($product->id); ?>"  class="productid"/>   
             </a> 
        <br>
              ...
              <?php if(Auth::check() && (Auth::user()->role!="admin" || Auth::user()->role!="dealer")): ?>
                <button type="submit"  style="margin-top:-55px;" class="btn btn-primary pull-right submit" name="submit" id="submit" onclick="addToCart(<?php echo e($product->id); ?>)">Add To Cart<i class="fa fa-cart-arrow-down" style="font-size:20px;"></i></button> 
              <?php else: ?>
              <button type="submit"  style="margin-top:-55px;" class="btn btn-primary pull-right submit" name="submit" id="submit" onclick="addToCart(<?php echo e($product->id); ?>)">Add To Cart<i class="fa fa-cart-arrow-down" style="font-size:20px;"></i></button> 
              <?php endif; ?>
