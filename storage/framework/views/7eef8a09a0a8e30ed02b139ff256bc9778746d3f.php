...
<?php if(session('success')): ?>
	...
	<div style="text-align:right;padding-right:34px;">
			...
			<a class="btn btn-primary btn-lg py-3 px-5"style="background:#ffc20e;border-color:#ffc20e;" href="<?php echo e(url('/admin/product')); ?>"><b>New Product</b></a><br>
	</div><br>
						...
						?>
							<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr>		
									...
									<!-- <td><?php echo e($product->marathi_title); ?></td> -->
									<td><?php echo e($product->type); ?></td>
									<td><?php echo e($product->subtype); ?></td>
									...
									<!-- <td><?php echo e($product->remark1); ?></td> -->

									<!-- <td>
										<div class="btn-group" role="group">
											<a class="btn btn-success" href="<?php echo e(url('/productlist/stock/available/'.$product->id)); ?>">Available</a>
										</div>
									</td>

									<td>
										<div class="btn-group" role="group">
											<a class="btn btn-success" href="<?php echo e(url('/productlist/stock/'.$product->id)); ?>">Out Of Stock</a>
										</div>
									</td> -->

									<td>
										<div class="btn-group" role="group">
											<a class="btn btn-primary" href="<?php echo e(url('/productlist/edit/'.$product->id)); ?>" style="background:transparent;border-color:transparent"><i class="fa fa-edit" style="background:transparent;font-size:14px;"></i></a>
										</div>
									</td>
									<td>
										<div class="btn-group" role="group">
										<?php if($i>15): ?>
											<a class="btn btn-danger" href="<?php echo e(url('/productlist/delete/'.$product->id)); ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i></a>
										<?php endif; ?>
										</div>
									</td>
								</tr>
