      ...
      <div class="header-top-inner">
        ...
        <ul class="list-unstyled list-inline sansserif">
           ...
           <?php if(Auth::check()): ?>
            ...
            <li style="margin-left:140px;"><a href="<?php echo e(url('/admin')); ?>" style="color:black;" ><i class="icon fa fa-user"></i>My Account</a></li>
            <?php elseif(Auth::user()->role == "franchisee"): ?>
            <li style="margin-left:140px;"><a href="<?php echo e(url('/franchisee_account')); ?>" style="color:black;"><i class="icon fa fa-user"></i>My Account</a></li>
            <?php elseif(Auth::user()->role == "customer"): ?>
            <li style="margin-left:140px;"><a href="<?php echo e(url('/user_account')); ?>" style="color:black;"><i class="icon fa fa-user"></i>My Account</a></li>
            <!-- <li><a href="#"><i class="icon fa fa-heart"></i>Wishlist</a></li> -->
            <?php elseif(Auth::user()->role == "student"): ?>
            <li style="margin-left:140px;"><a href="<?php echo e(url('/student_account')); ?>" style="color:black;"><i class="icon fa fa-user"></i>My Account</a></li>
            <?php endif; ?>
            <?php endif; ?>
            ...
            <?php if(Auth::check()): ?>
            <li>
	        <a href="<?php echo e(url('/user/logout')); ?>" style="color:black;"><i class="icon fa fa-user"></i>Logout</a></li>
          
        
         
                <li style="margin:0px 5px;"><a href="<?php echo e(url('/customer')); ?>" class="sansserif" style="font-family: 'Orbitron', sans-serif;color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
                <i class="fa fa-user" aria-hidden="true"></i> REGISTER AS CUSTOMER</a></li>
                <li style="margin:0px 5px"><a href="<?php echo e(url('/franchisee')); ?>" class="sansserif" style="font-family: 'Orbitron', sans-serif;color:white;background-color:#b60a0a;padding-right:10px;padding-left:10px;">
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="<?php echo e(url('/')); ?>"> <img src="<?php echo e(asset('images/new/Logofinal.png')); ?>" alt="logo" style="height:80px; margin-top:-20px;"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
