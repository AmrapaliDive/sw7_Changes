...
<div class="container col-md-6 offset-md-4" >
	...
	<a class="btn btn-primary btn-lg pull-right "style="background:#ffc20e;border-color:#ffc20e;float:right;width:200px;margin:10px;margin-top:0px;font-size:1.4rem" href="<?php echo e(url('/admin/orderlist2')); ?>">Find Records</a>
	</div></center><br>
	</div>
						...
						<?php if($order != null): ?>
							<?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<tr>		
									...
									<td>
									<a href="<?php echo e(url('/admin/cart/'.$order->id)); ?>" class="btn btn-primary pull-left" style="background:white;border-color:white;"><i class="fa fa-cart-arrow-down" style="font-size:20px;background:white;"></i></a>
                                     </td>
								</tr>
