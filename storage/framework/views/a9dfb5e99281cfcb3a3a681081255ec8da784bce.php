...
<div class="hero-wrap" style="background-image: url(<?php echo e(asset('/images/bg_3.jpg')); ?>);">
    ...
    <div class="col-md-6 col-md-offset-4 ftco-animate text-center">
            <h2 class="" style="font-size:40px;"><b>Admin Panel</b></h2>
						...
						<a style="font-size:20px;" type="button" class="btn-lg btn-block" href="<?php echo e(url('/productlist')); ?>">Product List</a>
					</div>
	        <div class="col-md-6 col-md-offset-4"style="margin-top:50px;">
						<a style="font-size:20px;" type="button" class="btn-lg btn-block"  href="<?php echo e(url('/franchiseelist')); ?>">Franchisee List</a>
					</div>
					<div class="col-md-6 col-md-offset-4"style="margin-top:50px">
						<a style="font-size:20px;" type="button" class="btn-lg btn-block"  href="<?php echo e(url('/customerlist')); ?>">Customer List</a>
					</div>
          <!-- <div class="col-md-6 col-md-offset-4"style="margin-top:50px">
          ...
          <div class="col-md-6 col-md-offset-4"style="margin-top:50px">
			...
			<div class="col-md-6 col-md-offset-4"style="margin-top:50px">
						<a style="font-size:20px;" type="button" class="btn-lg btn-block"  href="<?php echo e(url('/admin/userblogs')); ?>">Blogs</a>
					</div>

					<div class="col-md-6 col-md-offset-4"style="margin-top:50px">
						<a style="font-size:20px;" type="button" class="btn-lg btn-block"  href="<?php echo e(url('/admin/map')); ?>">Change Location</a>
					</div>
	</div>
