                      ...
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image img-hei">
                            <div class="image"> <a href="<?php echo e(url('/all_new_laptop')); ?>"> <img src="images/new/hp-laptop.png" class="img-hei" alt=""> </a> </div>
                          </div>
                        ...
                        <div class="col col-xs-7">
                           <div class="product-info">
                            <h3 class="name"><a href="<?php echo e(url('/all_new_laptop')); ?>" class="product-link">Laptop</a></h3>
                      ...
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="<?php echo e(url('/all_new_desktop')); ?>"> <img src="images/new/desktop2.png" class="img-hei"  alt=""> </a> </div>
                            <!-- /.image --> 
                        ...
                        <div class="col col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="<?php echo e(url('/all_new_desktop')); ?>" class="product-link">Desktop</a></h3>
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        ...
                        <div class="col col-xs-7">
                          <div class="product-info">
                            <h3 class="name"><a href="<?php echo e(url('/all_accessories')); ?>" class="product-link">Accessories</a></h3>
                            <!--<div class="rating rateit-small"></div>-->
                            <!-- <div class="product-price"> <span class="price"> Ã¢â€šÂ¹450.99 </span> </div> -->
                            <!-- /.product-price --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="<?php echo e(asset('images/new/printer1.png')); ?>" class="img-hei" alt=""></a> </div>
                            <!-- /.image --> 
                              ...
                              <div class="card" style="width: 100%;height:50vh;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <ul class="syllabus_list" style="margin-bottom:10px;">
                                      ...
                                      <li><a href="<?php echo e(url('/course_select/Laptop Repairing Course')); ?>">Read More</a></li>
                                    </ul>
                                    <div style="width:100%;padding: 10px 35px;">
                                      <a href="<?php echo e(url('/course_select/Laptop Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn">Register Now</a>
                                    </div>
                                  </div>
                              </div>
                <!-- /.hot-deal-wrapper -->                
                         ...
                         <div class="card" style="width: 100%;height:50vh;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <ul class="syllabus_list" style="margin-bottom:10px;">
                                      ...
                                      <li><a href="<?php echo e(url('/course_select/Printer Repairing Course')); ?>">Read More</a></li>
                                      
                                    </ul>
                                    <div style="width:100%;padding: 10px 35px;">
                                      <a href="<?php echo e(url('/course_select/Printer Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn">Register Now</a>
                                    </div>
                                  </div>
                          </div>
                <!-- /.hot-deal-wrapper -->
                          ...
                          <div class="card" style="width: 100%;height:50vh;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <ul class="syllabus_list" style="margin-bottom:10px;">
                                      ...
                                      <li><a href="<?php echo e(url('/course_select/LCD Repairing Course')); ?>">Read More</a></li>
                                      
                                    </ul>
                                    <div style="width:100%;padding: 10px 35px;">
                                      <a href="<?php echo e(url('/course_select/LCD Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn">Register Now</a>
                                    </div>
                                  </div>
                          </div>
                <div class="product-info text-left m-t-20">
                ...
                <div class="card" style="width: 100%;height:auto;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <ul class="syllabus_list" style="margin-bottom:10px;">
                                      ...
                                      <li>Touch and display solution</li>
                                      <li>Charging connector, sim tray replacement</li>
                                      <li><a href="<?php echo e(url('/course_select/Mobile Repairing Course')); ?>">Read More</a></li>
                                      
                                    </ul>
                                    <div style="width:100%;padding: 10px 35px 0px;">
                                      <a href="<?php echo e(url('/course_select/Mobile Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                                    </div>
                                  </div>
                          </div>
                <div class="product-info text-left m-t-20">               
                ...
                <div class="card" style="width: 100%;height:50vh;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <ul class="syllabus_list" style="margin-bottom:10px;">
                                      ...
                                      <li><a href="<?php echo e(url('/course_select/HDD Repairing Course')); ?>">Read More</a></li>
                                      
                                    </ul>
                                    <div style="width:100%;padding: 10px 35px;">
                                      <a href="<?php echo e(url('/course_select/HDD Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                                    </div>
                                  </div>
                          </div>
                <div class="product-info text-left m-t-20">                
              ...
              <div class="products">
                <div class="card" style="width: 100%;height:50vh;">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div style="width:100%;padding: 10px 35px;">
                                      <a href="<?php echo e(url('/course_select/CCTV Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                                    </div>
                                  </div>
                          </div>
                <div class="product-info text-left m-t-20">                 
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/wahs-repaire1.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Washing Machine Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/motor-winding.jpg" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Motor Winding Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/grinder.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Grinder Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/air-conditioning-repair.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/AC Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/freeze-repair.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Freeze Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/xerox-machine.webp" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Xerox Machine Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/fan-repairing1copy.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Fan Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/cooler.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Cooler Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn">Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/oven1.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Owen Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/elavator-repair.jpg" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Elevator Repairing Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/basic-ele.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Basic Electronic Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn" >Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
                  ...
                  <div class="card" style="width: 100%;height:50vh;">
                      <img class="card-img-top" style="width:100%;height:50%;" src="images/new/computer-hardware1copy1.png" alt="Card image cap">
                          <div class="card-body">
                              ...
                              <div style="width:100%;padding: 10px 35px;">
                                  <a href="<?php echo e(url('/course_select/Computer Hardware Course')); ?>" class="btn-upper btn btn-primary checkout-page-button course-btn">Register Now</a>
                              </div>
                          </div>
                  </div>
                  <div class="product-info text-left m-t-20">
        ...
        <h3 class="section-title" style="white-space:nowrap;">  Courses <marquee style="color:red;padding-left:40px;" behavior="sliding" width="60%" height="20px" scrollamount="3" direction="down">Book Your Seat Now!!!</marquee></h3>
           ...
           <div class="col-lg-4 col-sm-4" style="">
             ...
             <div class="product-image" style="">
                          <a href="<?php echo e(url('/student_registration')); ?>" class=" comboprop regcomb" style="background:#ffc206;color:white;padding-right:10px;padding-left:10px;">
      ...
      <?php if($product->type=="Laptop"): ?>    
            <div class="item item-carousel">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                  <div class="image"> <a href="<?php echo e(url('productview/'.$product->id)); ?>"><img  src="<?php echo e(asset('/images/products/'.$product->path)); ?>" alt="" class="img-thumbnail" style="width:180px;height:150px;"></a> <p class="name text-center"><a href="<?php echo e(url('productview/'.$product->id)); ?>"><?php echo e($product->product_name); ?></a><br>MRP :Rs. <span style="text-decoration:line-through;"><?php echo e($product->mrp); ?></span><br>Price :Rs.  <?php echo e($product->price); ?></p></div>
                  </div>
                  <!-- /.product-image -->
