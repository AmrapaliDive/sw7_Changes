...
<?php $__env->startSection('scripts'); ?>
	...
	<script src="<?php echo e(asset('js/articlesform.js')); ?>"></script>
	<!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/4.3.2/js/fileinput.min.js"></script> -->
	<script src="<?php echo e(asset('js/bootstrap-tagsinput.min.js')); ?>"></script>
...
<div class="container-fluid">
	...
	<?php endif; ?>
		 ...
		 <a class="btn btn-primary btn-lg col-md-2 col-md-offset-1 text-center" style="width:40px;font-size:20px;background:#ffc20e;color:#b60a0a;" href="<?php echo e(url('/productlist')); ?>" ><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="page-header ">
		...
		<?php if(isset( $products)): ?>
			<?php echo e(url('/admin/product/update/'. $products->id)); ?>

		<?php else: ?>
			<?php echo e(url('/admin/product/insert')); ?>
		...
		enctype="multipart/form-data">
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="form-group">
					...
					<?php if(isset( $products)): ?>
					<input type="text" placeholder="Enter Product Name" class="form-control" id="product_name" name="product_name" value="<?php echo e($products->product_name); ?>"required/>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="form-group">
					...
					<option value="Laptop" <?php echo e($products->type === 'Laptop' ? 'selected' : ''); ?>>Laptop</option>
					<option value="Laptop Peripheral Parts" <?php echo e($products->type === 'Laptop Peripheral Parts' ? 'selected' : ''); ?>>Laptop Peripheral Parts</option>
					<option value="Refurbished Laptop" <?php echo e($products->type === 'Refurbished Laptop' ? 'selected' : ''); ?>>Refurbished Laptop</option>
					<option value="Desktop" <?php echo e($products->type === 'Desktop' ? 'selected' : ''); ?>>Desktop</option>
					<option value="Refurbished Desktop" <?php echo e($products->type === 'Refurbished Desktop' ? 'selected' : ''); ?>>Refurbished Desktop</option>
					<option value="Printer" <?php echo e($products->type === 'Printer' ? 'selected' : ''); ?>>Printer</option>
					<option value="Accessories" <?php echo e($products->type === 'Accessories' ? 'selected' : ''); ?>>Accessories</option>
					<option value="Memory" <?php echo e($products->type === 'Memory' ? 'selected' : ''); ?>>Memory</option>
					<option value="Software" <?php echo e($products->type === 'Software' ? 'selected' : ''); ?>>Software</option>
					<option value="Repairing Tools" <?php echo e($products->type === 'Repairing Tools' ? 'selected' : ''); ?>>Repairing Tools</option>
					<option value="ICS" <?php echo e($products->type === 'ICS' ? 'selected' : ''); ?>>ICS</option>
					<option value="Components" <?php echo e($products->type === 'Components' ? 'selected' : ''); ?>>Components</option>
					<option value="Mobiles" <?php echo e($products->type === 'Mobiles' ? 'selected' : ''); ?>>Mobiles</option>
					<option value="Mobile Accessories" <?php echo e($products->type === 'Mobile Accessories' ? 'selected' : ''); ?>>Mobile Accessories</option>
					</select>
					<?php else: ?>
					<select  class="form-control " id="type" name="type" required>
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="form-group">
					...
					<option><?php echo e($products->subtype); ?> </option>
					</select>
					<?php else: ?>
					<select  class="form-control " id="subtype"  style="height:47px;font-size:1.5rem;" name="subtype" >
			...
			<!-- <div class="col-md-10 col-md-offset-1">
				...
				<?php if(isset( $products)): ?>
					...
					<option value="New" <?php echo e($products->subtype === 'New' ? 'selected' : ''); ?>>New</option>
					<option value="Refurbished" <?php echo e($products->subtype === 'Refurbished' ? 'selected' : ''); ?>>Refurbished</option>
					</select>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
					...
					<?php if(isset($products)): ?>
					<input type="number"    pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="stock" maxlength=6 placeholder="Enter Stock" name="stock"  value="<?php echo e($products->stock); ?>" required onblur = 'calculate()'/>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
					...
					<?php if(isset($products)): ?>
					<input type="number"    pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="mrp" maxlength=6 placeholder="Enter mrp" name="mrp"  value="<?php echo e($products->mrp); ?>" required onblur = 'calculate()'/>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
					...
					<?php if(isset($products)): ?>
					<input type="number" step="0.01"  pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="gst" maxlength=6 placeholder="Enter gst" name="gst"  value="<?php echo e($products->gst); ?>" required onblur = 'calculate()'/>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
					...
					<?php if(isset($products)): ?>
					<input type="number" step="0.01"  pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="discount" maxlength=6 placeholder="Enter discount" name="discount"  value="<?php echo e($products->discount); ?>" required onblur = 'calculate()'/>
					<?php else: ?>
			...
			<div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
					...
					<?php if(isset($products)): ?>
					<input type="number" step="0.01"  pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="price" maxlength=6 placeholder="Enter Price" name="price"  value="<?php echo e($products->price); ?>" required/>
					<?php else: ?>
			...
			<div class="form-group">
					...
					<?php if(isset($products)): ?> <?php echo e('Leave Blank to not change image'); ?> 
			...
			<div class="form-group">
					<label for="imagefile2">Product Image-2(Select Image)
						<?php if(isset($image)): ?> <?php echo e('Leave Blank to not change image'); ?> <?php endif; ?>
					</label>
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="form-group">
					...
					<?php if(isset($products)): ?>
					<input type="text" placeholder="Enter Product Video Link" class="form-control" id="video" name="video" value="<?php echo e($products->video); ?>"/>
					<?php else: ?>
