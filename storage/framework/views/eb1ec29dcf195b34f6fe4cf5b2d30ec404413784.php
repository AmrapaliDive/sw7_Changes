...
<center>
  <div class="col-xs-12 col-sm-12 top-search-holder"> 
          ...
          ?>
             <form action="<?php echo e(url('/serachCourses')); ?>" method="get">
                 ...
                 <option class="dropdown-menu" role="menu" value="">Select City</option>
                  <!-- <option class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="#" style="color:black;"><b class="caret"></b></a> -->
                    <ul class="dropdown-menu" role="menu" >
                      ...
                      <option role="presentation"><span role="menuitem" tabindex="-1" ><?php echo e($city->city); ?></span></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                  </option>
                </select>
             
			  <input type="hidden" id="course" name="course" value="<?php echo e($course); ?>">
...
<div class="">
    ...
    <h2>	<center>Batches</center></h2><br>
     ...
     <?php if($batches!=null): ?>
     <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batches): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<div class="4">
  ...
  background:white;height: fit-content;min-height:340px;">  
						...
						<a href="<?php echo e(url('batchview/'.$batches->id)); ?>" >
						
						<!-- <img class="card-img-top rounded mx-auto d-block" src="<?php echo URL::to('images/storage/batches',array($batches->course_image)); ?> " alt="Product" style="width:300px;height:200px;"> -->
           <center> <img style="margin-left: 0px;margin-right: 0px;width:200px;height:200px;" src="<?php echo URL::to('images/storage/batches',array($batches->course_image)); ?>  " alt="Product" class="img-responsive"></a></center>
         ...
         <?php
          ...
          ?>
						<h4 class="card-title text-center" style="font-family:Times New Roman, Times, serif"><?php echo e($batches->batch_name); ?></h4>
            <h4 class="card-title text-center" style="font-family:Times New Roman, Times, serif"><?php echo e($franchisee->city); ?></h4>
						<p class="card-text"><span id="rupee" class="rupee" style="color:#82ae46;font-size: 18px;"> </span>
						 ...
						 <input type="hidden" name="amount" id="amount"  value="<?php echo e($batches->course_final_fee); ?>"  class="amount"/>   
                        <input type="hidden" name="batchid" id="batchid"  value="<?php echo e($batches->id); ?>"  class="productid"/>      </p>
				   </div>
					  <ul class="list-group list-group-flush">
						<li class="list-group-item text-center" style="border:none;font-size:15px;"><span id="ruppee" class="ruppee" style=""> &#8377;</span>
					   <span class="card__by" id="card__by" name="card__by" style="font-family:sans-serif;"> <?php echo e($batches->course_final_fee); ?> (Including GST )</span> </li>
          ...
          <!-- <a href="<?php echo e(url('/enrolForAdmission/'.$batches->id)); ?>" class="btn btn-primary submit" name="submit" id="submit">Enrol To Batch</a> -->
          <a class="btn btn-primary" href="<?php echo e(url('/getcourseAdmission/'.$batches->id)); ?>" data-target="" data-toggle="modal">Register Now</a>
